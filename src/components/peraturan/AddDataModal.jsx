...
const AddDataModal = ({
  ...
  const resetForm = () => {
    ...
    // Reset state yang diterima dari props
    setSelectedKategoris([]);
    setSearchTerm("");
    setAlert({ show: false, type: "", message: "" });
  };
  ...
  return (
    <>
      {/* Alert Component - PERBAIKAN DI SINI
      {alert.show && (
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      name="nomor"
                      type="text"
                      placeholder="Contoh: Nomor 25 Tahun 2025"
                ...
                <div className="mt-1">
                    ...
                    {filteredKategoris.map((kategori, index) => (
                      ...
                      >
                        <input
                          ...
                          checked={selectedKategoris.includes(
                  ...
                  <div className="mt-1 flex justify-between items-center">
                    <span className="text-sm text-gray-500">
                      {selectedKategoris.length} kategori dipilih
                    </span>
                    {selectedKategoris.length > 0 && (
                      <button
                        type="button"
                        className="text-xs text-red-600 hover:text-red-800"
                        onClick={() => setSelectedKategoris([])}
                      >
                        Hapus semua
                      </button>
                    )}
